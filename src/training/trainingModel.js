    ...
    if (resultContribution[0].length > 0) {
      if (result.length > 0) {
        ...
        console.log(
          ...
          i,
          'stat:',
          statisticsResults.fivePrincipalMatchedFragments,
        );
      }
    }
  }
...
let boxplotNumberPicks = xBoxPlot(numberOfPicks);
boxplotResultsHplus.push({
  ...
  mean: meanFive,
  boxplotNumberPicks: boxplotNumberPicks,
...
fs.writeFileSync(
  join(__dirname, '/model/statistics_parameter3_2.json'),
